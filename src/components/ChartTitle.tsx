        ...
        <svg viewBox="0,0,128,128" width="32px" height="32px" data-tooltip-id="metric_tooltip" data-tooltip-content={props.info}>
          ...
          >
            <g transform="scale(1,1)">
              <circle cx="64" cy="64" r="55" fillOpacity="0" fill="#ffffff"></circle>
              <path
              ...
              <path
                ...
                fill="#24ae1d"
              ></path>
              <circle cx="64" cy="39" r="7" fillOpacity="0" fill="#e4e4e7"></circle>
              <path d="M57,68v24c0,3.9 3.1,7 7,7v0c3.9,0 7,-3.1 7,-7v-24c0,-3.9 -3.1,-7 -7,-7v0c-3.9,0 -7,3.1 -7,7z" fillOpacity="0" fill="#e4e4e7"></path>
              <path
